...
# 3.4 Dataclasses
# The dataclasses module (Python 3.7+) eliminates boilerplate for classes that
# primarily hold data. It auto-generates __init__, __repr__, and __eq__. Combined
# with type hints, dataclasses make configuration objects readable and safe.
